...
from activekg.connectors.retry import with_retry_and_dlq, TransientError, PermanentError
...
class IngestionProcessor:
    ...
    def _get_existing_node(self, external_id: str) -> Optional[dict]:
